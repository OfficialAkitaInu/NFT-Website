        ...
        <div className="footer">
            ...
            <div className="py-5 bg-dark-grey">
                <div className="container text-center">
                    <a href="how-to-buy.html" className="btn btn-light btn-sm mx-2 my-2">How to Buy</a>
                    <a href="https://app.tinyman.org/#/swap?asset_in=0&asset_out=384303832" target="_blank" rel="noreferrer" className="btn btn-light btn-sm mx-2 my-2">Swap on Tinyman</a>
                    <a href="https://algorand.foundation/" target="_blank" rel="noreferrer" className="btn btn-light btn-sm mx-2 my-2">Algorand Foundation</a><br />
